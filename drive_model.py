...
# Trained model path
MODEL_PATH = './models/fresh_models/model_rgb.h5'
...
def get_image():
    while True:
        try:
            ...
            return image_rgb[40:101,36:220,0:3].astype(float)
        except:
            print ("im error")
...
while True:    
    ...
    # Print progress
    print('Sending steering = {0}, throttle = {1}, prediction time = {2}'.format(car_controls.steering, car_controls.throttle,str(end_time-start_time)))
